...
exports.syncRewardDemo = syncRewardDemo;
exports.registerPartnerDemo = registerPartnerDemo;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const ledger_1 = require("../src/onchain/ledger");
const USER_WALLET_PATH = path_1.default.join(process.cwd(), '..', 'USER_WALLET.json');
function getCreatorWallet() {
    try {
        const raw = fs_1.default.readFileSync(USER_WALLET_PATH, 'utf-8');
 ...
 */
function syncRewardDemo(input) {
    const creatorWallet = getCreatorWallet();
    const ledger = (0, ledger_1.loadLedger)();
 ...
 */
function registerPartnerDemo(proposal, analysis) {
    const ledger = (0, ledger_1.loadLedger)();
    const partnerId = proposal.partnerId ||
        proposal.id ||
